    ...
    public class Student : ICloneable, IComparable<Student>
    {
        ...
        public string SSN
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentException("SSN should be in format XXX-XX-XXXX");
                }
            }
        }
        ...
        public string MobilePhone
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentException("Phone number should be in format 0XX-XXX-XXX");
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            studentInformation.AppendLine(string.Format("{0} {1} {2}", this.Name.FirstName, this.Name.MiddleName, this.Name.LastName));
            studentInformation.AppendLine(string.Format("SSN: {0}", this.SSN));
            studentInformation.AppendLine(string.Format("phone: {0}", this.MobilePhone));
            studentInformation.AppendLine(string.Format("email: {0}", this.EMail));
            studentInformation.AppendLine(string.Format("{0}, {1}, {2} - course: {3}", this.University, this.Faculty, this.Specialty, this.Course));
