    ...
    public class BitArray64 : IEnumerator<int>, IEnumerable<int>
    {
        ...
        public int this[int index]
        {
            get
            {
                ...
                return GetBitOnSurrentPosition(index);
            }
            set
            {
                if (index < 0 || index > 63)
                ...
                SetBitOnCurrentPosition(index, value);
            }
        }
        #endregion
        ...
        public int Current
        {
            get { return GetBitOnSurrentPosition(this.position); }
        }
        ...
        object IEnumerator.Current
        {
            get
            {
                return GetBitOnSurrentPosition(this.position);
            }
        }
        ...
        {
            this.position++;
            return (position < BitArrayCapacity);
        }
        ...
        public override string ToString()
        {
            ...
            for (int i = 63; i >= 0; i--)
            {
                toStringValue.Append(this[i]);
            }
            toStringValue.Append(Environment.NewLine);
        ...
        private int GetBitOnSurrentPosition(int position)
        {
