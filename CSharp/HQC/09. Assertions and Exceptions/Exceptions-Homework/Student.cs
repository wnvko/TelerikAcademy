...
public class Student
{
    ...
    public IList<ExamResult> CheckExams()
    {
        if (this.Exams == null)
        {
            throw new ArgumentNullException("Student exams list cannot be null!");
        }
    ...
    public double CalcAverageExamResultInPercents()
    {
        if (this.Exams == null)
        {
            ...
            throw new ArgumentNullException("Exam list cannot be null. Cannot calculate average exam result.");
        }
