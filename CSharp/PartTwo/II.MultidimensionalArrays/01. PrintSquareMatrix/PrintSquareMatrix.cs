...
namespace PrintSquareMatrix
{
    ...
    class PrintSquareMatrix
    {
        ...
        static void PrintMatrixTypeA(int matrixSize)
        {
        ...
        static void PrintMatrixTypeB(int matrixSize)
        {
            int[,] matrix = new int[matrixSize, matrixSize];
            int counter = 0;
            for (int col = 0; col < matrixSize; col++)
        ...
        static void PrintMatrixTypeC(int matrixSize)
        {
            int[,] matrix = new int[matrixSize, matrixSize];
            int counter = 0;
        ...
        static void PrintMatrixTypeD(int matrixSize)
        {
            int[,] matrix = new int[matrixSize, matrixSize];
            int counter = 0;
            int row = 0;
